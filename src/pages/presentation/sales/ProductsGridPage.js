...
const ProductsGridPage = () => {
	...
	return (
		<PageWrapper title={menuSidebar.sales.subMenu.productsGrid.text}>
			<SubHeader>
				<SubHeaderLeft>
					<Breadcrumb
						list={[
							{ title: menuSidebar.sales.text, to: menuSidebar.sales.path },
							{
								title: menuSidebar.sales.subMenu.productsGrid.text,
								to: menuSidebar.sales.subMenu.productsGrid.path,
							},
						]}
					/>
					<SubheaderSeparator />
