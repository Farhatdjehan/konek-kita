...
const Item = ({ name, teamName, attachCount, taskCount, percent, dueDate }) => {
	...
	const handleOnClickToProjectPage = useCallback(
		() => history.push(`${menuSidebar.projectManagement.subMenu.itemID.path}/1`),
		[history],
	);
	return (
...
const ProjectManagementsList = () => {
	...
	const handleOnClickToEmployeeListPage = useCallback(
		() => history.push(menuSidebar.appointment.SubMenu.employeeList.path),
		[history],
	);

	return (
		<PageWrapper title={menuSidebar.projectManagement.subMenu.list.text}>
			<SubHeader>
				<SubHeaderLeft>
