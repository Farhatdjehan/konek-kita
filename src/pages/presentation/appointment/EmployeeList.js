...
const EmployeeList = () => {
	...
	const searchUsers = Object.keys(USERS)
		...
		.map((i) => USERS[i]);
	return (
		<PageWrapper title={menuSidebar.appointment.subMenu.employeeList.text}>
			<SubHeader>
				<SubHeaderLeft>
					<label
				...
				<SubHeaderRight>
					...
					<Button
						...
						isLight
						tag='a'
						to={menuSidebar.editPages.subMenu.editWizard.path}>
						New Employee
					</Button>
				</SubHeaderRight>
			</SubHeader>
													...
													<div className='row'>
														...
														<div className='col-auto'>
															<Button
																...
																hoverShadow='sm'
																tag='a'
																to={`${menuSidebar.appointment.subMenu.employeeID.path}/${user.id}`}
															/>
														</div>
													</div>
													{!!user?.services && (
