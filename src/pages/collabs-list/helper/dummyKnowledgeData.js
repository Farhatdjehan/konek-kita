...
const data = [
	{
		id: 1,
		title: 'Video Klip Musik Terbaru Ahmad Dhani',
		description: 'Musik terbaru dari ahmad dhani',
		user: 'Ahmad Dhani',
		image: Img1,
	...
	{
		id: 2,
		title: 'Memasak bareng Anya Geraldine',
		description: 'Masak bareng Anya Geraldine with Juna Rorimpandey',
		user: 'Juna Rorimpandey',
		image: Img2,
