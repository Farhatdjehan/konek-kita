...
const TAGS = {
	SOCIAL: {
		text: 'SOCIAL',
		color: TIKTOK.SUCCESS.name,
	},
	CHARITY: {
		text: 'Charity',
		color: TIKTOK.DANGER.name,
	},
	CAMPAIGN: {
		text: 'Campaign',
		color: TIKTOK.PRIMARY.name,
	},
	LIVEMUSIC: {
		text: 'Live Music',
		color: TIKTOK.INFO.name,
	},
};
...
const data = [
	{
		id: 1,
		title: '#MajukanIndonesia76',
		description: 'Indonesia Maju, Indonesia Merdeka!',
		image: Img1,
		tags: [TAGS.SOCIAL, TAGS.CHARITY, TAGS.CAMPAIGN],
		color: TIKTOK.WARNING.name,
	...
	{
		id: 2,
		title: 'Internet Murah Untuk Bangsa #1',
		description: 'Internet murah untuk bangsa Indonesia, #PLNMaju',
		image: Img2,
		tags: [TAGS.SOCIAL, TAGS.CHARITY, TAGS.LIVEMUSIC],
		color: TIKTOK.PRIMARY.name,
	...
	{
		id: 3,
		title: 'Swab PCR Murah',
		description: 'Sekarang tes swab PCR mudah dan murah!',
		image: Img3,
		tags: [TAGS.SOCIAL, TAGS.CHARITY],
		color: TIKTOK.DANGER.name,
		categories: [CATEGORIES.INSTAGRAM, CATEGORIES.TWITTER],
		content:
	...
	},
	{
		...
		description: 'Gunakanlah sosial media anda dengan bijak',
		image: Img4,
		tags: [TAGS.SOCIAL, TAGS.CHARITY, TAGS.LIVEMUSIC],
		color: TIKTOK.SUCCESS.name,
		categories: [CATEGORIES.INSTAGRAM, CATEGORIES.TWITTER],
	...
	{
		id: 5,
		title: 'Kenali Dirimu #MentalHealth',
		description: 'Mental Health itu penting loh',
		image: Img5,
		tags: [TAGS.SOCIAL, TAGS.CHARITY],
		color: TIKTOK.INFO.name,
	...
	{
		id: 6,
		title: 'Internet Murah Untuk Bangsa #2',
		description: 'Internet murah untuk bangsa Indonesia, #PLNMaju',
		image: Img6,
		tags: [TAGS.SOCIAL, TAGS.CHARITY],
		color: TIKTOK.WARNING.name,
	...
	{
		id: 7,
		title: '#ProtokolKesehatan - Kemenkes',
		description: 'Tetap jaga protokol kesehatan agar Indonesia bebas Covid-19',
		image: Img4,
		tags: [TAGS.SOCIAL, TAGS.CHARITY],
		color: TIKTOK.DARK.name,
		categories: [CATEGORIES.TWITTER],
		content:
	...
	{
		id: 8,
		title: '#SayaBanggaIndonesia',
		description: 'Bangga jadi Indonesia, Bangga hidup di Indonesia',
		image: Img2,
		tags: [TAGS.SOCIAL, TAGS.CHARITY],
		color: TIKTOK.INFO.name,
